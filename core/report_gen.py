...
class ReportGenerator:
    ...
    def _render_markdown(self, data: dict) -> str:
        ...
        lines += ["---", "*Generated by r3con v5.0.2-fixed - Advanced Security Research Tool*"]
        return "\n".join(lines)
...
<div class="meta">
  ...
  <strong>Tool:</strong> r3con v5.0.2-fixed<br>
...
<p style="color:#334155;font-size:11px">Generated by r3con v5.0.2-fixed - Advanced Security Research Tool - For authorized testing only</p>
</body></html>"""
